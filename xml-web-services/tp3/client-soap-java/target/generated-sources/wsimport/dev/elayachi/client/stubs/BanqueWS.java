 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://server.elayachi.dev/", wsdlLocation = "http://localhost:9090/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://server.elayachi.dev/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://server.elayachi.dev/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.elayachi.dev/", "BanqueServicePort"), BanqueService.class, features);
    }
