 ...
 * generated in the dev.elayachi.client.stubs package. 
...
public class ObjectFactory {
    ...
    private static final QName _Compte_QNAME = new QName("http://server.elayachi.dev/", "compte");
    private static final QName _ConversionEuroToDH_QNAME = new QName("http://server.elayachi.dev/", "conversionEuroToDH");
    private static final QName _ConversionEuroToDHResponse_QNAME = new QName("http://server.elayachi.dev/", "conversionEuroToDHResponse");
    private static final QName _GetCompte_QNAME = new QName("http://server.elayachi.dev/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://server.elayachi.dev/", "getCompteResponse");
    private static final QName _GetComptes_QNAME = new QName("http://server.elayachi.dev/", "getComptes");
    private static final QName _GetComptesResponse_QNAME = new QName("http://server.elayachi.dev/", "getComptesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dev.elayachi.client.stubs
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "conversionEuroToDH")
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "conversionEuroToDHResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://server.elayachi.dev/", name = "getComptesResponse")
